...
install: ## Install composer deps
	$(docker_compose_bin) -f docker-compose.yml exec -T --workdir="${SITE_APP_DIR}" --user="${CURRENT_USER}:${CURRENT_USER_ID}" ${APACHE_CONTAINER_NAME} composer create-project symfony/skeleton
